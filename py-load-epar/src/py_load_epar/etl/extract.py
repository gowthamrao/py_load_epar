...
def extract_data(
...
) -> tuple[Iterator[Dict[str, Any]], datetime.datetime | None]:
    """
    ...
    are newer than the provided high_water_mark.
    ...
    Returns:
        ...
        - The new high water mark (the latest date found in the source file).
    """
    ...
    def data_iterator() -> Iterator[Dict[str, Any]]:
        nonlocal new_high_water_mark
        ...
        try:
            ...
            for row in sheet.iter_rows(min_row=2, values_only=True):
                ...
                if isinstance(update_date_val, str):
                    try:
                        ...
                        if " " in update_date_val:
                            ...
                            update_date_val = datetime.datetime.fromisoformat(
                                update_date_val
                            )
                ...
                # Track the latest date seen in the file for the new HWM
                if new_high_water_mark is None or update_date_val > new_high_water_mark:
                    new_high_water_mark = update_date_val
            ...
            if download_path and download_path.exists():
                ...
                try:
                    ...
                    pass  # Ignore if dir not empty

    return data_iterator(), new_high_water_mark
